    ...
    */
    ...
    protected function create(array $data)
    {
	   ...
	   $create = User::create([
		 ...
		 Mail::send([], [],function ($message) use($create)
                		{
      		$html = "<html>
			<head>
				<title></title>
				...
				<link href='http://localhost/Email-Template/Verify-1/averta-v2.css' rel='stylesheet' type='text/css'>
				<style type='text/css'>
					@import url(http://localhost/Email-Template/Verify-1/averta-v2.css);
				</style>
				 <style type='text/css'>
					p {
						margin: 0 0 24px 0;
					...
					.body-wrapper {
						background: #f2f5f7 url('/Email-Template/Verify-1/background-v1.png') no-repeat center top;
						padding: 0px;
						margin: auto;
					}
																			...
																			<tbody>
																				<tr>
																					<td style='width:150px;'>
																						<img alt='Logo' title='' height='auto' src='https://d2yjfm58htokf8.cloudfront.net/static/images/tw_logo-v2.png' style='border:none;border-radius:0px;display:block;font-size:13px;outline:none;text-decoration:none;width:100%;height:auto;' width='150'>
																						</td>
																					</tr>
																				</tbody>
																			</table>
																	...
																	<tr>
																		<td style='word-wrap:break-word;font-size:0px;padding:0px;' align='left'>
																			<div style='cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;'>
																				<p>Hello {$create['name']},</p>
																				<p class='hero'>It’s time to Activate your account.</p>
																				<p>You’re almost done! Simply click below to activate your account.</p>
																				<p>
																					<a href='http://localhost/laravelframwork/laravel5.7/activite/token/id/{$create['random']}' class='btn' mc:disable-tracking=''><span style='color:#fff;'>Activate account</span></a>
																				</p>
																...
																<tr>
																	<td style='word-wrap:break-word;font-size:0px;padding:0px;' align='center'>
																		<div style='cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:14px;line-height:24px;letter-spacing:0.4px;text-align:center;'>You can find answers to common questions
																			...
																			<a href='mailto:support@transferwise.com'>support@transferwise.com</a>.
																		</div>
																	</td>
																</tr>
															</tbody>
													...
													<div class='mj-column-per-100 outlook-group-fix' style='vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;'>
														<table role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
															<tbody>
																<tr>
																	<td style='word-wrap:break-word;font-size:0px;padding:0px;' align='center'>
																		<div style='cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:14px;line-height:24px;letter-spacing:0.4px;text-align:center;'>TransferWise Limited is a company registered in England and Wales with registered number 07209813. Our registered office is at 56 Shoreditch High Street, London, E1 6JJ. TransferWise is an Electronic Money Institution authorised by the Financial Conduct Authority with firm reference 900507.</div>
																	</td>
																</tr>
															</tbody>
														</table>
												...
												<td style='word-wrap:break-word;font-size:0px;padding:0px;' align='center'>
													<table role='presentation' cellpadding='0' cellspacing='0' style='border-collapse:collapse;border-spacing:0px;' align='center' border='0'>
														<tbody>
															<tr>
																<td style='width:1px;'>
																	<img alt='' title='' height='1' src='https://api.transferwise.com/v1/notification-flow/messages/c6180a31-5cdb-477a-8c36-756232726efc/channels/EMAIL/open.gif' style='border:none;border-radius:0px;display:block;font-size:13px;outline:none;text-decoration:none;width:100%;height:1px;' width='1'>
																	</td>
																</tr>
															</tbody>
														</table>
			...
			$send ='info@mindzpark.com';
			$cmpname = 'Mindzpark';
			$email_data = $create['email'];
			$rpy = 'info@mindzpark.com';
