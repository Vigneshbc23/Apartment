...
<head>
    ...
    <script type="text/javascript" src="{{ asset('public/assets/js/pages/dashboard.js') }}"></script>
...
<body>
                    ...
                    <div class="sidebar-user-material">
                        ...
                        <div class="navigation-wrapper collapse" id="user-nav">
                            <ul class="navigation">
                                ...
                                <li><a class="legitRipple" href="{{ route('logout') }}"
 ...
 @yield('content')
    ...
    <!-- /page container -->
           <!-- Footer -->
     <div class="text-muted" style="text-align: right;margin-top: -20px;">
